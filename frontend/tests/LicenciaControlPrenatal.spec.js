...
test('Empleado pide licencia Nacimiento de hijo (solo el 27 de mayo)', async ({ page }) => {
  // Login como empleado
  ...
  // Motivo
  await page.fill('textarea[name="reason"]', 'Motivo de la solicitud: nacimiento de hijo.');
