...
test('"Crear usuario no válido (Correo ya utilizado) " )', async ({ page }) => {
  ...
  // Otros campos
  await page.fill('input[name="email"]', 'juansaltiva2000@gmail.com'); // Correo ya utilizado
  await page.fill('input[name="password"]', '123456');
  await page.fill('input[name="confirmPassword"]', '123456');
  await page.fill('input[name="phone"]', '12345678910');
...
const mensajeError = page.getByText(/error al crear el usuario/i);
