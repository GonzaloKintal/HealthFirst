...
test('"Crear usuario no válido (La Fecha de Nacimiento es de una persona de 17 años)")', async ({ page }) => {
  ...
  // Otros campos
  await page.fill('input[name="email"]', 'TC21@gmail.com');
  ...
  await page.waitForTimeout(3000); // Esperar a que procese
    const mensajeError = page.getByText(/El usuario debe ser mayor de edad/i);
