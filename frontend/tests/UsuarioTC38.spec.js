...
test('Crear usuario no válido (Confirmar contraseña distinta a Contraseña))', async ({ page }) => {
  ...
  await page.fill('input[name="email"]', 'TC38@gmail.com');
  await page.fill('input[name="password"]', '123456'); // ❌ Contraseña de 6 caracteres
  await page.fill('input[name="confirmPassword"]', '123457'); // Contraseña distinta
