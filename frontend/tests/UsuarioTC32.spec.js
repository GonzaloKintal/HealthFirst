...
test('"Crear usuario no válido (Correo al que le falta segundo grupo de caracteres despues del @)" )', async ({ page }) => {
  ...
  // Otros campos
  await page.fill('input[name="email"]', 'TC32@gmailcom'); // Correo vacío
