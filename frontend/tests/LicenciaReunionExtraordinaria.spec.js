...
test('Reunion Gremial extraordinaria', async ({ page }) => {
  // Login
  ...
  await page.selectOption('select[name="licenseTypeId"]', '20');
  ...
  await page.fill('textarea[name="reason"]', 'Debo asistir a una reunion gremial extraordinaria.');
