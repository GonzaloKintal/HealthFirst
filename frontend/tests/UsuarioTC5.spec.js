...
test('Crear usuario no valido (nombre de 1 letra)', async ({ page }) => {
  ...
  await page.fill('input[name="first_name"]', 'J');
  ...
  // Otros campos
  await page.fill('input[name="email"]', 'empleado5@gmail.com');
...
await expect(page.locator('input[name="first_name"]')).toHaveClass(/border-red-500/);
