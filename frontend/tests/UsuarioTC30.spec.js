...
test('"Crear usuario no válido(Correo al que le falta primer grupo de caracteres antes del @)" )', async ({ page }) => {
  ...
  // Otros campos
  await page.fill('input[name="email"]', '@gmail.com'); // Correo vacío
