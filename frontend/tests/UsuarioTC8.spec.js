...
test('Crear usuario válido (apellido al borde inferior de clase válida)', async ({ page }) => {
...
await page.fill('input[name="last_name"]', 'Li');
...
await page.fill('input[name="email"]', 'empleado6@gmail.com');
