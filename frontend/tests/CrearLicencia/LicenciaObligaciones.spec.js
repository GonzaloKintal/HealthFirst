...
test('Obligaciones Punlicas', async ({ page }) => {
  // Login
  ...
  await page.selectOption('select[name="licenseTypeId"]', '16'); // Mudanza
  ...
  await page.fill('textarea[name="reason"]', 'Debo asistir trámite oficial.');
