...
test('Empleado pide licencia por Donacion de sangre', async ({ page }) => {
  // Login como empleado
  ...
  await page.selectOption('select[name="licenseTypeId"]', '14');
  ...
  // Motivo
  await page.fill('textarea[name="reason"]', 'Donacion de sangre.');
