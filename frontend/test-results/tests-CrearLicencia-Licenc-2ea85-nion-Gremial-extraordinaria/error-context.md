...
- Name: Reunion Gremial extraordinaria
- Location: C:\Users\Juans\HealthFirst\frontend\tests\CrearLicencia\LicenciaReunionExtraordinaria.spec.js:4:1
...
============================================================
    at C:\Users\Juans\HealthFirst\frontend\tests\CrearLicencia\LicenciaReunionExtraordinaria.spec.js:47:14
```
...
- main:
  ...
  - combobox:
    ...
    - option "Representante gremial" [selected]
    - option "Reunión extraordinaria"
    - option "Otros"
  - text: Días Solicitados
  - textbox: 1 día(s)
  - text: Fecha de Inicio *
  - textbox "Seleccione fecha de inicio": 28/05/2025
  - text: Fecha de Fin *
  - textbox "Seleccione fecha de fin": 28/05/2025
  - text: Motivo *
  - textbox "Describa el motivo de su solicitud...": Debo asistir a una reunion gremial extraordinaria.
...
```ts
   ...
   3 |
   4 | test('Reunion Gremial extraordinaria', async ({ page }) => {
   5 |   // Login
  ...
  10 |   await page.selectOption('select[name="licenseTypeId"]', '20');
  11 |
  ...
  30 |     await days.nth(todayIndex + 1).click();
  31 |   };
  32 |
  ...
  42 |   await page.fill('textarea[name="reason"]', 'Debo asistir a una reunion gremial extraordinaria.');
