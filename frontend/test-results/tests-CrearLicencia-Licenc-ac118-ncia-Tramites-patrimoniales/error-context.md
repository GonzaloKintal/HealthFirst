...
- Name: Empleado pide licencia Tramites patrimoniales
- Location: C:\Users\Juans\HealthFirst\frontend\tests\CrearLicencia\LicenciaTramitesPatrimoniales.spec.js:4:1
...
Call log:
  ...
  - waiting for locator('text=Éxito! Tu licencia ha sido creada')
    ...
    at C:\Users\Juans\HealthFirst\frontend\tests\CrearLicencia\LicenciaTramitesPatrimoniales.spec.js:48:28
```
...
```ts
   ...
   3 |
   4 | test('Empleado pide licencia Tramites patrimoniales', async ({ page }) => {
  ...
  31 |
  32 |   // Motivo
  33 |   await page.fill('textarea[name="reason"]', 'Tramite patrimoniales.');
  34 |
